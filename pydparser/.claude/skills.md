# Skill: pydparser Technical Extraction
...
- **Constraint**: Optimized for standard HR entities; may require fallback if IT-specific terminology is highly non-standard.# Skill: Standardized Job Parsing
- **Expertise**: Extracting structured metadata from IT job postings using pydparser.
...
- **Constraint**: Prioritize built-in pydparser extraction patterns over custom regex.
